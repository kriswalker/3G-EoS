...
function getImagePortion(c, imgObj, array, label){
    ...
    var list = {}
    list['source_4_nact_20'] = ['chirp_mass', 'mass_ratio', 'dec', 'ra', 'psi', 'phase', 'geocent_time', 'lambda_1', 'lambda_2', 'a_1', 'a_2', 'tilt_1', 'tilt_2', 'phi_12', 'phi_jl', 'luminosity_distance', 'log_likelihood', 'total_mass', 'mass_1', 'mass_2', 'symmetric_mass_ratio', 'iota', 'chi_eff', 'chi_p', 'redshift', 'mass_1_source', 'mass_2_source', 'chirp_mass_source', 'total_mass_source', 'lambda_tilde', 'delta_lambda'];
    ...
    var data = {}
    data['source_4_nact_20'] = {'width': 200.00000000000006, 'height': 200.0, 'seperation': 9.999999999999943, 'x0': 100.0, 'y0': 100.0};
